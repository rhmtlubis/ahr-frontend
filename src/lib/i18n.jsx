...
const translations = {
  id: {
    ...
    cart: {
      ...
      summaryTitle: 'Checkout & pembayaran',
      ...
      authOrDivider: 'atau',
      googleLoginSuccess: 'Login Google berhasil.',
      googleLoginNeedsPhone: 'Login Google berhasil. Lengkapi nomor WhatsApp di profil.',
      googleLoginError: 'Login Google gagal. Silakan coba lagi atau gunakan email.',
      accountTitle: 'Akun customer aktif',
      accountBody: 'Lengkapi identitas dan alamat pengiriman sebelum lanjut ke pembayaran.',
      logout: 'Keluar',
      password: 'Password',
      passwordConfirmation: 'Konfirmasi password',
      forgotPasswordLink: 'Lupa password?',
      forgotPasswordTitle: 'Reset password',
      forgotPasswordBody: 'Masukkan email akun Anda. Kami kirim link untuk membuat password baru.',
      forgotPasswordCta: 'Kirim link reset',
      forgotPasswordBack: 'Kembali ke login',
      resetPasswordTitle: 'Buat password baru',
      resetPasswordBody: 'Masukkan password baru untuk akun Anda.',
      resetPasswordCta: 'Simpan password baru',
      loginCta: 'Masuk',
      registerCta: 'Buat akun',
      authLoading: 'Memeriksa sesi customer...',
      authRequired: 'Silakan login atau buat akun customer sebelum checkout.',
      profileSyncing: 'Menyimpan profil customer...',
  ...
  en: {
    ...
    cart: {
      ...
      subtotalManual: 'Estimated price',
      ...
      googleLoginNeedsPhone: 'Google sign-in successful. Please add your WhatsApp number in your profile.',
      googleLoginError: 'Google sign-in failed. Please try again or use email instead.',
      accountTitle: 'Customer account active',
      accountBody: 'Complete your identity and shipping address before continuing to payment.',
      logout: 'Log out',
      password: 'Password',
      passwordConfirmation: 'Confirm password',
      forgotPasswordLink: 'Forgot password?',
      forgotPasswordTitle: 'Reset password',
      forgotPasswordBody: 'Enter your account email. We will send a link to create a new password.',
      ...
      authLoading: 'Checking customer session...',
      authRequired: 'Please log in or create a customer account before checkout.',
      profileSyncing: 'Saving customer profile...',
