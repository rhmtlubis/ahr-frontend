      ...
      <main className="all-products-page">
        ...
        >
          <div className="all-products-toolbar" data-products-hero>
            ...
            <div className="all-products-toolbar-controls">
              <label className="all-products-sort-trigger">
                ...
                >
                  <option value="newest">{SORT_OPTIONS.newest}</option>
                  <option value="priceDesc">{SORT_OPTIONS.priceDesc}</option>
                  <option value="priceAsc">{SORT_OPTIONS.priceAsc}</option>
                </select>
                <ChevronDown size={16} />
              </label>
            </div>
